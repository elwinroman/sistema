        ...
        Promise.all(u).then((n) => {
            ...
            Array.from(r).forEach((e) => {
                const s = e.cells[t],
                    i = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                let a;
                (a = u ? u(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i), parseFloat(a) == a ? (o[d++] = { value: Number(a), row: e }) : (h[l++] = { value: "string" == typeof i ? i.toLowerCase() : i, row: e });
            }),
                e || (e = c.classList.contains("asc") ? "desc" : "asc"),
                "desc" == e ? ((p = a(h, -1)), (f = a(o, -1)), c.classList.remove("asc"), c.classList.add("desc")) : ((p = a(o, 1)), (f = a(h, 1)), c.classList.remove("desc"), c.classList.add("asc")),
            ...
            const g = [];
            r.forEach((t, e) => {
                i.data.push(t.row), null !== t.row.searchIndex && void 0 !== t.row.searchIndex && g.push(e);
            }),
                (i.searchData = g),
                this.rebuild(),
                i.update(),
...
class l {
    constructor(t, e = {}) {
        ...
        if (
            ((this.options = { ...o, ...e, layout: { ...o.layout, ...e.layout }, labels: { ...o.labels, ...e.labels } }),
            (this.initialized = !1),
    ...
    static extend(t, e) {
        "function" == typeof e ? (l.prototype[t] = e) : (l[t] = e);
    }
    init(t) {
        ...
        if ((s(this.pagers), this.totalPages > 1)) {
            ...
            this.options.truncatePager &&
                (r = ((t, s, i, a, n) => {
                    ...
                    const d = [],
                        c = [];
                    s < 4 - a + h ? (l = 3 + h) : s > i - (3 - a + h) && (o = i - (2 + h));
                    for (let e = 1; e <= i; e++)
                        if (1 == e || e == i || (e >= o && e <= l)) {
                            const s = t[e - 1];
                ...
                if ("txt" === l.type || "csv" === l.type) {
                    for (h = "", n = 0; n < i.length; n++) {
                        for (r = 0; r < i[n].cells.length; r++)
                            if (!l.skipColumn.includes(s[r].originalCellIndex) && this.columns(s[r].originalCellIndex).visible()) {
                    ...
                    for (h = `INSERT INTO \`${l.tableName}\` (`, n = 0; n < s.length; n++) !l.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (h += `\`${s[n].textContent}\`,`);
                    for (h = h.trim().substring(0, h.length - 1), h += ") VALUES ", n = 0; n < i.length; n++) {
                        for (h += "(", r = 0; r < i[n].cells.length; r++) !l.skipColumn.includes(s[r].originalCellIndex) && this.columns(s[r].originalCellIndex).visible() && (h += `"${i[n].cells[r].textContent}",`);
                        (h = h.trim().substring(0, h.length - 1)), (h += "),");
                    }
                    (h = h.trim().substring(0, h.length - 1)), (h += ";"), l.download && (h = `data:application/sql;charset=utf-8,${h}`);
                } else if ("json" === l.type) {
                    for (r = 0; r < i.length; r++)
                        for (a[r] = a[r] || {}, n = 0; n < s.length; n++) !l.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (a[r][s[n].textContent] = i[r].cells[n].textContent);
        ...
        t.exports = (function () {
            var t = 1e3,
                ...
                v = {
                    ...
                    p: function (t) {
                        return (
                            { M: l, y: c, w: o, d: h, D: u, h: r, m: n, s: a, ms: i, Q: d }[t] ||
                            String(t || "")
                                .toLowerCase()
                                .replace(/s$/, "")
                        );
            ...
            var C = function (t) {
                ...
                x = function (t, e, s) {
                    var i;
                    if (!t) return y;
                    if ("string" == typeof t) w[t] && (i = t), e && ((w[t] = e), (i = t));
                    else {
                        var a = t.name;
                        (w[a] = t), (i = a);
                    }
            ...
            var T = (function () {
                    ...
                    return (
                        ...
                        (b.$g = function (t, e, s) {
                            return $.u(t) ? this[e] : this.set(s, t);
                        }),
                        (b.unix = function () {
                        ...
                        (b.startOf = function (t, e) {
                            var s = this,
                                ...
                                d = $.p(t),
                                p = function (t, e) {
                                    var a = $.w(s.$u ? Date.UTC(s.$y, e, t) : new Date(s.$y, e, t), s);
                                    return i ? a : a.endOf(h);
                                },
                                f = function (t, e) {
                                    return $.w(s.toDate()[t].apply(s.toDate("s"), (i ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), s);
                                },
                                g = this.$W,
                                m = this.$M,
                                b = this.$D,
                            ...
                            switch (d) {
                                ...
                                case l:
                                    return i ? p(1, m) : p(0, m + 1);
                                case o:
                                    var y = this.$locale().weekStart || 0,
                                        w = (g < y ? g + 7 : g) - y;
                                    return p(i ? b - w : b + (6 - w), m);
                                case h:
                                case u:
                                    return f(v + "Hours", 0);
                                case r:
                        ...
                        (b.$set = function (t, e) {
                            var s,
                                o = $.p(t),
                                d = "set" + (this.$u ? "UTC" : ""),
                                p = ((s = {}), (s[h] = d + "Date"), (s[u] = d + "Date"), (s[l] = d + "Month"), (s[c] = d + "FullYear"), (s[r] = d + "Hours"), (s[n] = d + "Minutes"), (s[a] = d + "Seconds"), (s[i] = d + "Milliseconds"), s)[
                                    o
                                ],
                                f = o === h ? this.$D + (e - this.$W) : e;
                            if (o === l || o === c) {
                                var g = this.clone().set(u, 1);
                                g.$d[p](f), g.init(), (this.$d = g.set(u, Math.min(this.$D, g.daysInMonth())).$d);
                            } else p && this.$d[p](f);
                        ...
                        (b.add = function (i, d) {
                            ...
                            var f = $.p(d),
                                g = function (t) {
                                    var e = M(p);
                                    return $.w(e.date(e.date() + Math.round(t * i)), p);
                                };
                            if (f === l) return this.set(l, this.$M + i);
                            if (f === c) return this.set(c, this.$y + i);
                            if (f === h) return g(1);
                            if (f === o) return g(7);
                            var m = ((u = {}), (u[n] = e), (u[r] = s), (u[a] = t), u)[f] || 1,
                                b = this.$d.getTime() + i * m;
                            return $.w(b, this);
                        }),
                        ...
                        (b.format = function (t) {
                            ...
                            var i = t || "YYYY-MM-DDTHH:mm:ssZ",
                                ...
                                f = {
                                    ...
                                    M: h + 1,
                                    MM: $.s(h + 1, 2, "0"),
                                    MMM: d(s.monthsShort, h, l, 3),
                                    MMMM: d(l, h),
                                    D: this.$D,
                                    DD: $.s(this.$D, 2, "0"),
                                    d: String(this.$W),
                                    dd: d(s.weekdaysMin, this.$W, o, 2),
                                    ddd: d(s.weekdaysShort, this.$W, o, 3),
                                    dddd: o[this.$W],
                                    H: String(n),
                                    HH: $.s(n, 2, "0"),
                                    h: c(1),
                        ...
                        (b.diff = function (i, u, p) {
                            var f,
                                g = $.p(u),
                                m = M(i),
                                b = (m.utcOffset() - this.utcOffset()) * e,
                                v = this - m,
                                y = $.m(this, m);
                            return (y = ((f = {}), (f[c] = y / 12), (f[l] = y), (f[d] = y / 3), (f[o] = (v - b) / 6048e5), (f[h] = (v - b) / 864e5), (f[r] = v / s), (f[n] = v / e), (f[a] = v / t), f)[g] || v), p ? y : $.a(y);
                        }),
            ...
            function u(s) {
                ...
                for (
                    ...
                    var l = r[o],
                        ...
                        u = d && d[0],
                        p = d && d[1];
                    r[o] = p ? { regex: u, parser: p } : l.replace(/^\[|\]$/g, "");
                }
                return function (t) {
                    for (var e = {}, s = 0, i = 0; s < h; s += 1) {
                        var a = r[s];
                ...
                i.parse = function (t) {
                    ...
                    if ("string" == typeof h) {
                        ...
                        l && (c = r[2]),
                            ...
                            d && e != this.format(h) && (this.$d = new Date("")),
                            (n = {});
                    } else if (h instanceof Array)
                        for (var p = h.length, f = 1; f <= p; f += 1) {
                            r[1] = h[f - 1];
        ...
        if (e)
            switch (e) {
                case "ISO_8601":
                    ...
                    break;
                case "RFC_2822":
                    s = c(t.slice(5), "DD MMM YYYY HH:mm:ss ZZ").unix();
                    break;
                case "MYSQL":
                    s = c(t, "YYYY-MM-DD hh:mm:ss").unix();
                    break;
                case "UNIX":
                    s = c(t).unix();
                    break;
